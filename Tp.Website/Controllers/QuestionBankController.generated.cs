...
namespace Tp.Website.Controllers
{
    public partial class QuestionBankController
    {
        ...
        protected QuestionBankController(Dummy d)
        {
        }
        ...
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Name = "QuestionBank";
        [GeneratedCode("R4Mvc", "1.0")]
        public const string NameConst = "QuestionBank";
        [GeneratedCode("R4Mvc", "1.0")]
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_QuestionBankController : Tp.Website.Controllers.QuestionBankController
    {
        public R4MVC_QuestionBankController(): base(Dummy.Instance)
        {
        }
